...
var (
	...
	EndpointGuildMemberAvatar         = func(gID, uID, aID string) string { return EndpointGuilds + gID + "/users/" + uID + "/avatars/" + aID + ".png" }
	EndpointGuildMemberAvatarAnimated = func(gID, uID, aID string) string { return EndpointGuilds + gID + "/users/" + uID + "/avatars/" + aID + ".gif" }
